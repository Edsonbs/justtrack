...
<head>
    ...
    @vite(['resources/css/header.css', 'resources/css/general.css', 'resources/css/popularView.css', 'resources/js/animacion_texto_ancho.js', 'resources/js/botones_listas.js'])
</head>
